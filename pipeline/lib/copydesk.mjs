...
- Attribution. Name each source once, where its information first enters. After that the reporting verb («وأضاف»، «وأوضح») or one attribution at the head of the paragraph («وبحسب رويترز، …») carries it. Never tag two sentences in a row with «وفقاً لـ/بحسب»; never «وفقاً للمصدر نفسه»; never one outlet more than three times in a story; a market price needs its source once. The BBC is «بي بي سي», never «الهيئة». An unnamed source is one source only inside one report: «مسؤول إيراني كبير» of 23 September and «مسؤول إيراني كبير» of 24 September are two people, so the second is never «وأضاف المسؤول» or «المسؤول نفسه». A speaker says only what the story had him say: a comment of the story's own stays the story's («وهو تذبذب يدلّ على…»), never «ورأى أن…» in his mouth.
