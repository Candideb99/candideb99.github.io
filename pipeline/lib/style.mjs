...
export const BANNED = [
  ...
  // «أدنى مستوى في المادة عند 97.55» (the first في العمق piece, 2026-09-24): the writer's input named as a
  // place; «في المادة 5» (a law's article) and «المادة الخام» are Arabic and pass.
  { re: /(?:المادة|المواد) (?:المرفقة|المتاحة|المقدمة)|(?:تشير|تُشير|تذكر) المادة|المادة لا (?:تشير|تُشير|تذكر|تقول|تحدد)|(?:في|وفق|بحسب) الملاحظات(?![؀-ۿ])|(?<![؀-ۿ])(?:في|من|وفق|بحسب|ضمن) (?:المادة|المواد)(?=\s*(?:[،.؛:]|$|(?:عند|إلى|على|من|في|حين|مع|خلال|بين)(?![؀-ۿ])))/gm, fix:"لغة التعليمات تسربت إلى المقال («المادة»، «الملاحظات»)؛ اذكر المصدر نفسه", hard: true },
